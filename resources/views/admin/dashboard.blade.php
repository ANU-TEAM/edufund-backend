            ...
            <div class="flex-sm-00-auto mt-3 mt-sm-0 ml-sm-3">
              <span class="d-inline-block invisible" data-toggle="appear" data-timeout="350">
                <a class="btn btn-primary px-4 py-2" data-toggle="click-ripple" href="#">
                  <i class="fa fa-plus mr-1"></i> New Blog Post
                </a>
              </span>
            </div>
          </div>
        ...
        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
          <a class="block block-rounded block-link-pop border-left border-info border-4x"
            ...
            <div class="block-content block-content-full">
              ...
              <div class="font-size-h2 font-w400 text-dark">4</div>
            </div>
          </a>
        </div>
        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
          <a class="block block-rounded block-link-pop border-left border-primary border-4x"
            href="#">
            <div class="block-content block-content-full">
              <div class="font-size-sm font-w600 text-uppercase text-muted">Published Posts</div>
              <div class="font-size-h2 font-w400 text-dark">43</div>
            </div>
          </a>
        </div>
        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
          <a class="block block-rounded block-link-pop border-left border-danger border-4x"
            href="#">
            <div class="block-content block-content-full">
              <div class="font-size-sm font-w600 text-uppercase text-muted">Trashed Posts</div>
              ...
              <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-none d-sm-table-cell text-center">
                      <img class="img-avatar img-avatar32" src="{{ asset('assets/media/avatars/avatar14.jpg') }}" alt="">
                    </td>
                    <td class="font-w600">
                      Jeffrey Shaw </td>
                    <td class="d-none d-sm-table-cell text-center">
